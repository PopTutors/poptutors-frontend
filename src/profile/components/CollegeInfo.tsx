  ...
  const reviews = [
    {
      ...
      stars: 4,
      comment: 'excelent conversation with him.. very knowledgeble personhappy to talk towith him',
    },
    {
      name: 'Ankit Srivastava',
      stars: 4,
      ...
      <div className="w-full max-w-2xl mt-6 space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {reviews.map((review, idx) => (
            <div key={idx} className="border rounded-xl p-4 text-sm text-gray-700 shadow-sm">
