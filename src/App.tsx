...
function App() {
  const jsonLdObject = {
    ...
    "description": "PopTutors is your one-stop solution for academic help: assignments, live doubt-solving, and 1-on-1 expert sessions.",
    "sameAs": [
    ...
    "department": [
      {
        ...
        "description": "Submit your brief, review tutor offers, and get your assignments delivered on time."
      },
      {
        "@type": "EducationalAudience",
    ...
    "review": [
      ...
      },
      {
        ...
        "reviewBody": "This platform pairs students with vetted pros—I’ve never had a smoother collaboration.",
        "reviewRating": { "@type": "Rating", "ratingValue": "5", "bestRating": "5" }
      },
      {
        "@type": "Review",
        "author": { "@type": "Person", "name": "Anita" },
        "reviewBody": "Clear workflows and milestone payments make Pop Tutors my go-to tutoring network.",
        "reviewRating": { "@type": "Rating", "ratingValue": "5", "bestRating": "5" }
      }
    ]
  };
