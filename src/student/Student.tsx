...
const sampleNotifications = [
  ...
  { user: "Kevin", message: "sent you message", action: "What is ux", course: "2024 ui/ux", time: "19 mins ago", icon: NotificationIcon },
];
  ...
  return (
    <div>
      <div className="flex wrap justify-between gap-2 my-4">
        <div style={{ fontWeight: "900" }} className="text-[13px] text-[#334d6e] mb-4 font-poppinsmedium">
          3 Recent Assignments, 2 Live Questions & 1 Paid Session are in progress
        </div>
        ...
        <div className="lg:col-span-3">
          ...
          <div className="p-5 mt-8  bg-white">
            <div className="flex items-center gap-2 mb-4">
              <h2 className="text-lg font-poppinsregular text-[#1f2442]">23 December, Sunday</h2>
            ...
            {isLoading ? (
              ...
              <p className="text-red-500 font-poppinsregular">Failed to load assignments.</p>
            ) : (
