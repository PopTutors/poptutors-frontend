                    ...
                    {cardData.map((item) => (
                        ...
                        >
                            ...
                            <div className="mb-3 sm:mb-0">
                                <div className={`text-[18px] md:text-[24px] font-semibold ${item.textColor}`}>{item.value}</div>
            ...
            <div className=" bg-white rounded-lg shadow">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 px-2 md:px-4 py-3">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2">
                        <label className="text-[13px] sm:text-[14px] font-poppinsregular text-[#262626]">Sort By:</label>
                        <DropdownMenu>
                            <DropdownMenuTrigger
                                className="
      ...
      "
                    ...
                    <div className="flex flex-col md:flex-row md:justify-end gap-3 md:gap-2">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                            <label className="text-[13px] sm:text-[14px] font-poppinsregular text-[#262626]">Date:</label>
                            {/* Start Date */}
                        ...
                        <tbody>
                            {transactions.map((tx, idx) => (
                                ...
                                >
                                    ...
                                    <td className="py-5 px-4 font-poppinsregular md:text-[14px] text-[12px] ">{tx.service}</td>
                                    <td className="py-5 px-4 font-poppinsregular md:text-[14px] text-[12px]">{tx.transactionId}</td>
                                    <td className="py-5 px-4 font-poppinsregular md:text-[14px] text-[12px]">{tx.note}</td>
                                    <td className="py-5 px-4 font-poppinsregular md:text-[14px] text-[12px]">{tx.dateTime}</td>
                                    <td className="py-5 px-4 font-poppinsmedium md:text-[14px] text-[12px]">{tx.amount}</td>
                                    <td className={`py-5 px-4 font-poppinsmedium md:text-[14px] text-[12px] ${statusClasses[tx.status]}`}>
                                        {tx.status}
                                    </td>
