...
function Input({ className, type, ...props }: React.ComponentProps<'input'>) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        'w-full h-[40px] border border-gray-300 bg-white px-3 py-2 text-sm text-primary font-poppinsregular font-normal', // clean white bg + primary text + normal weight
