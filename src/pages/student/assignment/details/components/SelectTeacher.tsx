        ...
        <section className="bg-white rounded-lg">
            <div>
                <div className="flex items-center justify-between px-5 pt-5">
                    ...
                    <Button variant="pill_solid" className='font-poppinssemibold bg-primary text-white text-sm py-1'>
                        Pick For Me
                    </Button>
                </div>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 p-5'>
                    {[
                        ...
                        <div key={index} className="flex flex-col gap-3 items-center justify-between border border-gray-200 rounded-lg p-2">
