      ...
      <HeroSection>
        <div className="font-bold">
          ...
          <span className="text-xl">
            in Particular fields then Poptutors is Here
          </span>
        </div>
        <div className="absolute -bottom-5 w-11/12 translate-y-1/2 bg-accent px-2 text-center text-sm text-gray-500">
          Poptutors is here to provide expertise in specific fields, surpassing
          my own capabilities. Whether it&apos;s science, technology, or any
          specialized area, Poptutors brings a wealth of knowledge and guidance.
          Together, we make a formidable team, ready to tackle any challenge.
        </div>
      </HeroSection>
