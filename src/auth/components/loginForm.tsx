...
const LoginForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex w-full flex-col items-center gap-5 text-gray-600">
      ...
      {error && <div className="text-red-500 font-medium w-full text-left">{error}</div>}
